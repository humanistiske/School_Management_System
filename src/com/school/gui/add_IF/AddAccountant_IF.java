...
import com.school.gui.add_IF.AddAccountantInfoPanel.AccountantAccountInfoPanel;
import com.school.gui.add_IF.AddAccountantInfoPanel.AccountantInfoPanel;
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				else
				{
					try
					{
						...
						accountant.setPassword(String.valueOf(userLoginPanel.tfPassword.getPassword()));
