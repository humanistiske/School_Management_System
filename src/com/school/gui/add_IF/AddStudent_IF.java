...
import com.school.gui.add_IF.AddStudentInfoPanel.StudentAccountInfoPanel;
import com.school.gui.add_IF.AddStudentInfoPanel.StudentInfoPanel;
					...
					public void actionPerformed(ActionEvent e) 
					{
						...
						else
						{
							try
							{
								...
								student.setPassword(String.valueOf(userLoginPanel.tfPassword.getPassword()));
