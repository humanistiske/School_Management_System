...
import com.school.gui.internalFrames.AddAdminInfoPanel.AdminAccountInfoPanel;
import com.school.gui.internalFrames.AddAdminInfoPanel.AdminInfoPanel;
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				else
				{
					try
					{
						...
						admin.setPassword(userLoginPanel.tfPassword.getPassword().toString());
