...
public class EditStudentInfoPanel 
{
	protected class StudentInfoPanel
	{
		...
		public JPanel createStudentInfoPanel()
		{
			...
			cbClassId.setSelectedItem(EditStudent_IF.student.getClassId());
			tfTotalSubjects.setText(String.valueOf(EditStudent_IF.student.getTotal_subjects()));
			listSelectedSubjectModel.clear();
			for(String subject : EditStudent_IF.student.getSubjectList().values())
			{
				listSelectedSubjectModel.addElement(subject);
			}
			listSubjectModel.clear();
			for(String subject : subjectDb.getSubjectList(EditStudent_IF.student.getClassId()).values())
	        {
			...
			bAddSubjects.addActionListener(new ActionListener()
					{
						...
						public void actionPerformed(ActionEvent e) 
						{
								...
								else
								{
									selectedSubjectList.put(
											(Integer)SystemUtils.getKeyFromValue(
													subjectDb.getSubjectList(EditStudent_IF.student.getClassId()), subject), subject);
									listSelectedSubjectModel.clear();
							...
							EditStudent_IF.student.setSubjectList(selectedSubjectList);
