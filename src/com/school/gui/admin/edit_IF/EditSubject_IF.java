...
public class EditSubject_IF 
{
	public static Subject subject; 
	public final EditSubjectInfoPanel editSubjectInfoPanel = new EditSubjectInfoPanel();
	public final JPanel pSubjectInfo = new JPanel();
	final JInternalFrame addSubject_IF = new JInternalFrame("Edit Subject", true, true, true, true);
	...
	{
		EditSubject_IF.inputError = inputError;
	}

	public JInternalFrame editSubject_IF()
	{
		try
		{
			ResultSet rs = new SubjectDb().getSubjectInfoDb(subject.getSubjectId());
			while(rs.next())
			{
				subject.setClassId(rs.getString("classid"));
		...
		pSubjectInfo.add(editSubjectInfoPanel.createAddSubjectInfoPanel(), "SubjectInfo");
		...
		EditSubject_IF.pInputError.add(error);
		...
		bSubmit.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
					subject.setSubjectName(editSubjectInfoPanel.tfSubjectName.getText());
					subject.setClassId(editSubjectInfoPanel.cbClassId.getSelectedItem().toString());

					try
					{
						if(new SubjectDb().updateSubject())
	...
	protected class EditSubjectInfoPanel 
	{
		...
		public JPanel createAddSubjectInfoPanel() 
		{
			...
			cbClassId.setSelectedItem(subject.getClassId());
